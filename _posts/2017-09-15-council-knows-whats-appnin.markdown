...
The article (which has since been edited on [the Barnsley Chronicle website](https://www.barnsleychronicle.com/article/council-launches-new-app)) originally read:
